...
CREATE TABLE `user_info_0` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=353121857899069461 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_info_1` (
  ...
  `mobile` char(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=353121857370587157 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_info_2` (
  ...
  `mobile` char(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=353121856066158613 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_info_3` (
  ...
  `mobile` char(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=353121852056403989 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_info_4` (
  ...
  `mobile` char(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=353121858909896725 DEFAULT CHARSET=utf8;
